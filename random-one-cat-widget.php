...
class RandomOneCatWidget extends WP_Widget {
	...
	function form($instance) {
		...
		$instance = wp_parse_args((array) $instance, array('title' => __('Random Posts', 'random_one_cat'), 'category' => 1, 'show_post_title' => 4, 'show_custom_fields' => 0, 'number_of_posts' => 1, 'title_links' => 0, 'shorten_posts' => 0));
		...
		?>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('shorten_posts'); ?>"><?php _e('Shorten Post to More...?', 'random_one_cat'); ?></label>
			</p>
			<p>
		<?php
	}
