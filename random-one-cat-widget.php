...
function widget_random_one_cat_init() {
	...
	function widget_random_one_cat_control($widget_args) {
		...
		widget_random_one_cat_form(compact('number', 'title', 'category', 'show_post_title'));
	}
...
function widget_random_one_cat_process($widget_random_one_cat) {
	...
	return compact('title', 'category', 'show_post_title');
}

function widget_random_one_cat_form($args, $inputs = null) {
	$default_inputs = array('title' => true, 'category' => true, 'show_post_title' => true);
...
function widget_random_one_cat_register() {
	...
	foreach (array_keys($options) as $o) {
		if (!isset($options[$o]['title']) || !isset($options[$o]['category']) || !isset($options[$o]['show_post_title'])) { continue; }
		$id = "random_one_cat-$o";
